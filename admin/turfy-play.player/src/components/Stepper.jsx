                ...
                return (
                    <div key={index} className="flex items-center gap-2">
                        <div className="flex items-center gap-2">
                            <div className={`w-6 h-6 md:w-8 md:h-8 rounded-full flex justify-center items-center font-medium text-sm
                                ${isActive ? "bg-emerald-500 text-white" : "bg-slate-700 text-gray-300"}
                            `}>
                                {stepNumber}
                            </div>
                        ...
                        {index < steps.length - 1 && (
                            <FiChevronRight className={`${stepNumber < currentStep ? "text-emerald-500" : "text-gray-400"} `}/>
                        )}
                    </div>
                )
            })}
