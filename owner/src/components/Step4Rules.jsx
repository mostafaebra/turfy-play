      ...
      <div>
        ...
        >
          <div className="flex flex-col gap-2">
            ...
            />
            {errors.openTime && (
              <span className="text-xs text-red-500">{errors.openTime}</span>
            )}
          </div>
          ...
          <div className="flex flex-col gap-2">
            ...
            />
            {errors.closeTime && (
              <span className="text-xs text-red-500">{errors.closeTime}</span>
            )}
          </div>
        </div>
      </div>
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="relative">
              ...
              >
                ...
                <option value="free_24h">
                  Free refund if cancelled 24h prior
                </option>
                <option value="free_48h">
                  Free refund if cancelled 48h prior
                </option>
